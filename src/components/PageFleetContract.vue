<template>
  <div id="fleet-contract">
    <button class="add">
      <router-link :to="{name: 'PageFleetContractAdd'}">Add New Contract</router-link>
    </button>
    <div class="search-box">
      ...
      <div class="labels">
        ...
        <label>
          <p>Area</p>
          <input type="text" v-model="search.area">
        </label>
        <div class="control">
          ...
          <tbody v-if="!noData">
            <tr v-for="i in 10" :key="i">
              ...
              <td>
                ...
                <i class="view">
                  <router-link :to="{name: 'PageFleetContractInfo'}">View</router-link>
                </i>
              </td>
            </tr>
          </tbody>
