    ...
    <div class="page">
      <div class="title">
        ...
        <div class="control">
          ...
          <button class="cancel"><router-link :to="{name: 'PageLockInfo'}">Cancel</router-link></button>
        </div>
      </div>
      <div class="content">
        <div class="box">
          <div class="item" :class="{'error': add.lockId.error}">
            <p class="title">Lock ID</p>
            <div class="text">
              <input type="text" v-model="add.lockId.value">
              <p class="error-text">{{ add.lockId.errorText }}</p>
            </div>
          </div>
          <div class="item" :class="{'error': add.rcz.error}">
            <p class="title">RCZ</p>
            <div class="text">
              <input type="text" v-model="add.rcz.value">
              <p class="error-text">{{ add.rcz.errorText }}</p>
            </div>
          </div>
          <div class="item" :class="{'error': add.sigfoxId.error}">
            <p class="title">Sigfox ID</p>
            <div class="text">
              <input type="text" v-model="add.sigfoxId.value">
              <p class="summary">Name can have alphanumeric characters</p>
              <p class="error-text">{{ add.sigfoxId.errorText }}</p>
            </div>
          </div>
          <div class="item" :class="{'error': add.status.error}">
            <p class="title">Ststus</p>
            <div class="text">
              <input type="text" v-model="add.status.value">
          ...
          <div class="item" :class="{'error': add.blueId.error}">
            <p class="title">Blue tooth UUID</p>
            <div class="text">
              <input type="text" v-model="add.blueId.value">
              <p class="error-text">{{ add.blueId.errorText }}</p>
            </div>
          </div>
        </div>
      ...
      <div class="popup" :class="{'active': popup.status}">
        ...
        <div class="box">
          <div class="item">
            <p class="title">Lock ID</p>
            <p class="text">{{ add.lockId.value }}</p>
          </div>
          <div class="item">
            <p class="title">RCZ</p>
            <p class="text">{{ add.rcz.value }}</p>
          </div>
          <div class="item">
            <p class="title">Sigfox ID</p>
            <p class="text">{{ add.sigfoxId.value }}</p>
          </div>
          <div class="item">
          ...
          <div class="item">
            <p class="title">Compay</p>
            <p class="text">{{ add.company.value }}</p>
          </div>
          <div class="item">
            <p class="title">Blue tooth UUID</p>
            <p class="text">{{ add.blueId.value }}</p>
          </div>
        </div>
        <div class="controls">
