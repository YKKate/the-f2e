<template>
  <div id="fleet-history">
    <h2 class="title">Lock 0012233 HISTORY</h2>
    <div class="search-box">
      ...
      <label>
        <p>Duration</p>
        <input type="text" v-model="search.duration">
      </label>
      <div class="control">
    ...
    <div class="result-list">
      <div class="tabs">
        <router-link :to="{name: 'PageFleetHistoryRoute'}">LOCK ROUTE HISTORY</router-link>
        <router-link :to="{name: 'PageFleetHistoryError'}">LOCK ERROR HISTORY</router-link>
        <router-link :to="{name: 'PageFleetHistoryAlert'}">LOCK ALERT HISTORY</router-link>
        <router-link :to="{name: 'PageFleetHistoryParking'}">LOCK PARKING HISTORY</router-link>
      </div>
      <div class="table">
        <table>
          <thead>
          ...
          <tbody v-if="!noData">
            <tr v-for="i in 10" :key="i">
              ...
              <td>
                ...
                <!-- <i class="edit">
                  <router-link :to="{name: 'PageFleetHistoryEdit'}">Edit</router-link>
                </i> -->
              </td>
            </tr>
          </tbody>
...
#fleet-history {
  ...
  margin: auto;
  margin-top: $marginVerticle;
  margin-bottom: $marginVerticle;
  overflow-y: auto;
  h2 {
    width: 100%;
    padding: 25px 40px;
