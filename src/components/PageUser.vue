<template>
  <div id="user">
    <button class="add">
      <router-link :to="{name: 'PageUserAdd'}">Add New User</router-link>
    </button>
    <div class="search-box">
      ...
      <div class="labels">
        ...
        <label>
          <p>Contract Name</p>
          <select v-model="search.contract">
          ...
          <tbody v-if="!noData">
            <tr v-for="i in 10" :key="i">
              ...
              <td>
                ...
                <i class="logout" @click="popup.status = true">logout</i>
                <i class="view">
                  <router-link :to="{name: 'PageUserInfo'}">View</router-link>
                </i>
              </td>
            </tr>
          </tbody>
    ...
    <div class="popup" :class="{'active': popup.status}">
      <p class="title">提示窗</p>
      <p class="content">Are you sure want to 'XXX' logout</p>
      <div class="controls">
        <button class="yes" @click="popup.status = false">Yes</button>
        <button class="no" @click="popup.status = false">No</button>
      </div>
    </div>
  </div>
</template>
